-- Fix reports table if it exists with enum constraint
DO $$ 
BEGIN
  -- Drop the table if it exists (this will cascade to all constraints)
  DROP TABLE IF EXISTS public.reports CASCADE;
  
  -- Recreate the table with proper TEXT field
...
EXCEPTION
  WHEN OTHERS THEN
    RAISE NOTICE 'Error creating reports table: %', SQLERRM;
END $$;
